...
function PublicationDoiLink({ slug }: { slug: string }) {
  const publication = publications.find((entry) => entry.slug === slug);
  if (!publication?.doi || !publication.externalUrl) return null;

  return <> — <a href={publication.externalUrl} target="_blank" rel="noopener noreferrer">DOI: {publication.doi}</a></>;
}
...
const cvSections = [
  ...
  { id: "expertise", number: "02", title: "Core research & editorial expertise", content: <><p className="cv-keywords">Cyanobacterial Biotechnology · Phycobiliproteins · Redox Biology · Mechanistic Phytomedicine</p><p>Research expertise integrates cyanobacterial physiology, cultivation and downstream processing, functional bioactivity, and mechanistic interpretation. Academic appraisal expertise includes analytical-unit independence, replication, control integrity, causal inference, multi-omics interpretation, network pharmacology, and computational-to-experimental validation.</p></> },
  { id: "publications", number: "03", title: "Publications", content: <ul><li>Process-oriented optimization of phycobiliprotein production in <em>Arthrospira platensis</em> through interaction-driven nutrient–stress regulation — Process Biochemistry, 2026<PublicationDoiLink slug="process-oriented-phycobiliprotein-optimization" /></li><li>Enhanced recovery of phycobiliproteins from <em>Arthrospira platensis</em> by combined glass bead vortexing and ultrasonication — Discover Applied Sciences, 2026<PublicationDoiLink slug="enhanced-phycobiliprotein-recovery" /></li><li>Effects of salinity, iron, and nitrogen on growth, chlorophyll content, and phycobiliproteins, with emphasis on physiological adaptive responses of <em>Spirulina platensis</em> — accepted, 2026</li></ul> },
